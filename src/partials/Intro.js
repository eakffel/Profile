...
<div className="flex align-left justify-center mt-8 ">
<a ClassName="Resume" 
     ...
     <img className="flex flex-col sm:flex-row w-25 h-40 mx-auto sm:m-2 shadow-xl square" src={Rpic} alt='PDF'/>
    </a >  
    <a ClassName="Resume2" 
     ...
     <img className="flex flex-col sm:flex-row w-25 h-40 mx-auto sm:m-2 shadow-xl square" src={Rpic2} alt='PDF'/>
    </a >  
